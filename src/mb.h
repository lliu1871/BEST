...
#define ALLOC_CURLNGENE		83           /* prior for joint gene tree*/
#define ALLOC_CURLNJOINT	84

#define	NUM_LINKED				19               /* prior for joint gene tree */
#define	LINKED					0
#define	UNLINKED				1
#define	P_TRATIO				0
#define	P_REVMAT				1
...
#define	P_BRSIGMA				16
#define	P_GROWTH				17 
#define 	P_GENEMU                	18  /* prior for joint gene tree */
...
#define	MAX_NUM_DIV_BITS		1010
#define 	MAX_NUM_DIV_LONGS       	1 + MAX_NUM_DIV_BITS / 32
#define	MAX_NUM_TAXASETS			200
...
typedef struct pNode
	...
	MrBFlt			length, support, f, age, theta,mu; /*prior for joint gene tree*/
	char			label[100];
	long int		*partition;
	Calibration		*calibration;
	}
...
#define     GENEMU_UNI                               109     /* prior for joint gene tree */
#define     GENEMU_FIX                               110
#define     GENEMU_GAMMA                             111
...
typedef struct model
	...
	MrBFlt		thetaFix;
	MrBFlt		thetaUni[2];
	MrBFlt		thetaGamma[2];  /*prior for joint gene tree*/
	MrBFlt		thetaExp;
	...
	char		GeneMuPr[100];  /* prior for joint gene tree */
	MrBFlt      GeneMuFix;
	MrBFlt      GeneMuUni[2];
	MrBFlt      GeneMuGamma[2];
...
typedef struct modelinfo
	...
	Param       *GeneMu;					/*prior for joint gene tree */
